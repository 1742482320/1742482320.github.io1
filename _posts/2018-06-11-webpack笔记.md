...
指定入口文件后，webpack将自动识别项目所依赖的其它文件，打包：

```
webpack app/main.js public/bundle.js
```

可以看出webpack同时编译了main.js 和Greeter,js,现在打开index.html,看结果
...
```
{
  ...
  "scripts": {
    "start": "webpack" //这里，JSON文件不支持注释，引用时请清除
  },
  "author": "zhang",
  "license": "ISC",
  "devDependencies": {
...
脚本命令：npm run {script name}如npm run build
